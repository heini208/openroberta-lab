...
@NepoExpr(
        name = "QISKIT_SINGLE_GATE",
        category = "ACTOR",
        blocklyNames = {"robActions_qiskit_single_gate"}
)
public final class SingleQubitGate extends Action {
    ...
    public SingleQubitGate(BlocklyProperties properties, String gate, Expr circuitId, Expr qubit) {
        super(properties);
        this.gate = gate;
