...
@NepoExpr(
        name = "QISKIT_RY",
        category = "ACTOR",
        blocklyNames = {"robActions_qiskit_ry"}
)
public final class RYGate extends Action {
    ...
    public RYGate(BlocklyProperties properties, Expr circuitId, Expr qubit, Expr angle) {
        super(properties);
