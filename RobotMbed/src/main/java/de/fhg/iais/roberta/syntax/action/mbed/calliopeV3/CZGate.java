...
@NepoExpr(
        name = "QISKIT_CZ",
        category = "ACTOR",
        blocklyNames = {"robActions_qiskit_cz"}
)
public final class CZGate extends Action {
    ...
    public CZGate(BlocklyProperties properties, Expr circuitId, Expr control, Expr target) {
        super(properties);
