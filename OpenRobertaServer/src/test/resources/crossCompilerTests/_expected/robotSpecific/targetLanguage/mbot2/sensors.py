...
def sensors():
    ...
    ___numVar = ultrasonic2.get(2)
    ___numVar = ultrasonic2.get(1)
    ...
    ___numVar = ( cyberpi.timer.get() - _timer1 )
    ___numVar = ( cyberpi.timer.get() - _timer2 )
    ___numVar = ( cyberpi.timer.get() - _timer3 )
    ___numVar = ( cyberpi.timer.get() - _timer4 )
    ___numVar = ( cyberpi.timer.get() - _timer5 )
...
def wait_until():
    ...
    while True:
        if cyberpi.get_acc("x")/ 9,80665 > 30:
            break
    while True:
        if ( cyberpi.timer.get() - _timer1 ) > 500:
            break
    while True:
    ...
    while True:
        if mbot2.EM_get_angle("EM1") > 180:
            break
    while True:
        if mbot2.EM_get_angle("EM1") > 2:
            break
    while True:
        if mbot2.EM_get_angle("EM1") < 30:
            break
