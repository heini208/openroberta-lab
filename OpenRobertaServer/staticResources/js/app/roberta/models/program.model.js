...
define(["require", "exports", "comm"], function (require, exports, COMM) {
    ...
    function externAPIRequest(urlAPI, data, successFn, errorFn) {
        COMM.externPost(urlAPI, data, successFn, errorFn);
    }
    exports.externAPIRequest = externAPIRequest;
});
