...
define(["require", "exports", "abstract.connections", "jquery", "guiState.controller", "program.model", "util.roberta", "message", "guiState.model", "robot.controller", "dapjs", "calliopeDapWrapper", "calliopePartialFlashing", "blockly", "thymio", "program.controller", "webview.controller", "comm", "log", "socket.io", "connection.controller"], function (require, exports, abstract_connections_1, $, GUISTATE_C, PROGRAM, UTIL, MSG, GUISTATE, ROBOT_C, dapjs_1, calliopeDapWrapper_1, calliopePartialFlashing_1, Blockly, THYMIO_M, PROG_C, WEBVIEW_C, COMM, LOG, IO, CONNECTION_C) {
    ...
    var CalliopeV3PartialFlashingConnection = /** @class */ (function (_super) {
        __extends(CalliopeV3PartialFlashingConnection, _super);
        function CalliopeV3PartialFlashingConnection() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.flashing = false;
            return _this;
        }
        CalliopeV3PartialFlashingConnection.prototype.connect = function (vendors, generatedCode) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, e_6;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (this.flashing) {
                                return [2 /*return*/, 'flashing'];
                            }
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 6, , 7]);
                            if (!(this.device === undefined)) return [3 /*break*/, 3];
                            _a = this;
                            return [4 /*yield*/, navigator.usb.requestDevice({
                                    filters: this.deviceFilters(vendors),
                                })];
                        ...
                        case 3:
                            if (!this.connection) {
                                this.connection = new calliopeDapWrapper_1.CalliopeDAPWrapper(this.device);
                            }
                            return [4 /*yield*/, this.connection.forceReconnectAsync()];
                        case 4:
                            _b.sent();
                            return [4 /*yield*/, this.upload(generatedCode)];
                        case 5: return [2 /*return*/, _b.sent()];
                        case 6:
                            e_6 = _b.sent();
                            this.removeDevice();
                            this.connection = undefined;
                            if (e_6.message && e_6.message.indexOf('selected') === -1) {
                                MSG.displayInformation({ rc: 'error' }, null, e_6.message, GUISTATE_C.getProgramName(), GUISTATE_C.getRobot());
                            }
                            return [2 /*return*/, 'error'];
        ...
        CalliopeV3PartialFlashingConnection.prototype.upload = function (generatedCode) {
            return __awaiter(this, void 0, void 0, function () {
                var flashing, e_7;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            flashing = new calliopePartialFlashing_1.CalliopePartialFlashing(this.connection);
                            return [4 /*yield*/, flashing.flashAsync(generatedCode, this.setTransferProgress)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3:
                            ...
                            this.removeDevice();
                            this.connection = undefined;
                            if (e_7.message && e_7.message.indexOf('disconnected') !== -1) {
                                return [2 /*return*/, 'disconnected'];
                            }
                            MSG.displayInformation({ rc: 'error' }, null, e_7.message, GUISTATE_C.getProgramName(), GUISTATE_C.getRobot());
                            return [2 /*return*/, 'error'];
                        case 4:
                            this.flashing = false;
                            return [7 /*endfinally*/];
        ...
        CalliopeV3PartialFlashingConnection.prototype.removeDevice = function () {
            _super.prototype.removeDevice.call(this);
            this.connection = undefined;
        };
        return CalliopeV3PartialFlashingConnection;
    }(AutoConnection));
    //ARDU
    ...
    var Edisonv3Connection = /** @class */ (function (_super) {
        ...
        Edisonv3Connection.prototype.webUSBOpenConnection = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, url, version, uidNumber, myData, e_8;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
    ...
    }(CalliopeV3PartialFlashingConnection));
