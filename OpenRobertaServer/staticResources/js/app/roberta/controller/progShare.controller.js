...
define(["require", "exports", "log", "util.roberta", "message", "guiState.controller", "galleryList.controller", "program.model", "userGroup.model", "blockly", "jquery", "table", "bootstrap-table"], function (require, exports, LOG, UTIL, MSG, GUISTATE_C, galleryList_controller_1, PROGRAM, USERGROUP, Blockly, $, table_1) {
